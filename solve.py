...
code_day = {
    ...
    'day3': ['lxmls/deep_learning/numpy_models/mlp.py',
             'lxmls/deep_learning/pytorch_models/mlp.py'],
    'day4': ['lxmls/sequences/structured_perceptron.py'],
    'day5': ['lxmls/parsing/dependency_decoder.py'],
    'day6': ['lxmls/deep_learning/numpy_models/rnn.py',
